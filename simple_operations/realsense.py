...
def realsense_init():
    ...
    return align, profile, pipeline


def get_aligned_images(align, profile, pipeline):
...
def get_coordinate(x, y, align, profile, pipeline):
    while 1:
        intr, depth_intrin, color_image, depth, aligned_depth_frame = get_aligned_images(align, profile, pipeline)  # 获取对齐的图像与相机内参
        ...
        img = cv2.circle(color_image, (x, y), 5, (255, 0, 0), 3)
...
align, profile, pipeline = realsense_init()
print(get_coordinate(100, 100, align, profile, pipeline))
